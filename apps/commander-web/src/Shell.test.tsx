...
describe('operator shell', () => {
  it('has no basic accessibility violations', async () => {
    ...
    expect(screen.getAllByText('Лендинги')).toHaveLength(2)
    expect(screen.getByRole('navigation', { name: 'Головна навігація на телефоні' }).querySelectorAll('button')).toHaveLength(6)
