...
for (const marker of ['Digital products and services by Natal.', 'Page not found', 'This Natal page is unavailable.', 'natal-service.com/']) {
...
process.stdout.write('Verified the noindex Natal shell, public route renderer, visual 404, and absence of auth/service-worker code.\n')
