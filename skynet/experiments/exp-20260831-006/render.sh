...
swift_dir="$root/runtime/swift-exp006"
module_cache="$swift_dir/module-cache"
temporary_dir="$swift_dir/tmp"
renderer="$swift_dir/render-exp006"
png="$script_dir/renders/cand-20260831-006-f-v1.png"
jpg="$script_dir/renders/cand-20260831-006-f-v1.jpg"
