                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: PtwSpacing.xs),
                            Text(
                              '${state.responseCountFor(project.id)} people already responded',
                        ...
                        Text(
                          'No account. Your name is never shown.',
...
final class _ProjectNotFound extends StatelessWidget {
  ...
  Widget build(BuildContext context) => const Scaffold(
    body: Center(child: Text('This project is no longer available.')),
  );
}
