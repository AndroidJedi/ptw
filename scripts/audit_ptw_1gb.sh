...
unexpected_pollers=$(ps -eo args= | grep -E 'idea_generation|commander\.worker|commander\.ad_worker|owner_gateway.*(poll|webhook)|marketing_positioning' | grep -v grep || true)
