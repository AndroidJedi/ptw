...
class AdWorkflowRepository(Protocol):
    ...
    def save_review_projection(self, *, feedback_id: str, creative_id: str, artifact_digest: str, rating: int | None, comment: str, predicted_ctr: float | None, annotations: tuple[Mapping[str, Any], ...], supersedes_feedback_id: str | None = None) -> None: ...
