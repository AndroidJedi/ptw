# Irreversible PTW Validation reset
...
`ptw_commander.public`; clear only obsolete generated Landing output under the
owner volume; apply the clean baseline; start Commander, Validation, and Owner
Gateway; verify zero Brief/creative/asset/feedback/graph counts and retired
Positioning/Landing table absence; compare
exact table counts captured from the independent platform database; remove the
retired Idea and Marketing Positioning containers only after readiness.
