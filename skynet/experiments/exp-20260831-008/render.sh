...
swift_dir="$root/runtime/swift-exp008"
module_cache="$swift_dir/module-cache"
temporary_dir="$swift_dir/tmp"
renderer="$swift_dir/render-exp008"
asset="$script_dir/assets/selective-return-route-v1.png"
png="$script_dir/renders/cand-20260831-008-h-v1.png"
jpg="$script_dir/renders/cand-20260831-008-h-v1.jpg"

mkdir -p "$swift_dir" "$script_dir/assets" "$script_dir/renders"
