...
def main() -> None:
    ...
    for label, marker in {
        ...
        "dedicated Commander workspace": "Commander conversation",
        "Commander plan implementation": "Implement plan",
        "Commander live steering": "Replies steer current work.",
        "Commander runtime effort selection": "Effort",
