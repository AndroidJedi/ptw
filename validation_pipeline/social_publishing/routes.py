"""Shared owner publication routes and bounded public media delivery."""
...
def social_publishing_router(
    service: Any, *, prefix: str, label: str,
    ...
    def invoke(fn: Any, *args: Any, **kwargs: Any) -> Any:
        try:
            ...
            raise HTTPException(404, f"{label} publication or approved source was not found") from error
    ...
    def connection() -> dict[str, Any]:
        return invoke(service.connection)
    ...
    def retry(
        project_id: str, publication_id: str, request: Mapping[str, Any],
